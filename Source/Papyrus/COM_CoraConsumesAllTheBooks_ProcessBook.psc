...
Event OnBegin(ObjectReference akSpeakerRef, Bool abHasBeenSaid)
  ; VPI_Debug.DebugMessage("COM_CoraConsumesAllTheBooks_ProcessBook", "OnBegin", "TOPIC (Book " + BookTitle + "): Event OnBegin Triggered.", 0, Venpi_DebugEnabled.GetValueInt())
EndEvent

Event OnEnd(ObjectReference akSpeakerRef, Bool abHasBeenSaid)
  ; VPI_Debug.DebugMessage("COM_CoraConsumesAllTheBooks_ProcessBook", "OnEnd", "TOPIC (Book " + BookTitle + "): Event OnEnd Triggered.", 0, Venpi_DebugEnabled.GetValueInt())
  ...
  VPI_Debug.DebugMessage("COM_CoraConsumesAllTheBooks_ProcessBook", "OnEnd", "TOPIC (Book " + BookTitle + "): Removed book " + BookCoraWants + " from player inventory and added one item. Player currently has given Cora " + totalBooksGivenCount + " books.", 0, Venpi_DebugEnabled.GetValueInt())
EndEvent
