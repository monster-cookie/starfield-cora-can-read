...
;;;
Event OnQuestInit()
  VPI_Debug.DebugMessage("COM_CoraConsumesAllTheBooks_Fragments", "OnQuestInit", "FRAGMENT: Event OnQuestInit Triggered.", 0, Venpi_DebugEnabled.GetValueInt())
EndEvent

Event OnQuestRejected()
  VPI_Debug.DebugMessage("COM_CoraConsumesAllTheBooks_Fragments", "OnQuestRejected", "FRAGMENT: Event OnQuestRejected Triggered.", 0, Venpi_DebugEnabled.GetValueInt())
EndEvent

Event OnQuestShutdown()
  VPI_Debug.DebugMessage("COM_CoraConsumesAllTheBooks_Fragments", "OnQuestShutdown", "FRAGMENT: Event OnQuestShutdown Triggered.", 0, Venpi_DebugEnabled.GetValueInt())
EndEvent

Event OnQuestStarted()
  VPI_Debug.DebugMessage("COM_CoraConsumesAllTheBooks_Fragments", "OnQuestStarted", "FRAGMENT: Event OnQuestStarted Triggered.", 0, Venpi_DebugEnabled.GetValueInt())
EndEvent

Event OnReset()
  VPI_Debug.DebugMessage("COM_CoraConsumesAllTheBooks_Fragments", "OnReset", "FRAGMENT: OnReset Triggered.", 0, Venpi_DebugEnabled.GetValueInt())
EndEvent

Event OnStageSet(Int auiStageID, Int auiItemID)
  VPI_Debug.DebugMessage("COM_CoraConsumesAllTheBooks_Fragments", "OnStageSet", "FRAGMENT: Event OnStageSet Triggered. Stage is " + auiStageID + " item is " + auiItemID + ".", 0, Venpi_DebugEnabled.GetValueInt())
EndEvent
...
Function Fragment_Stage_0001_Item_00()
  VPI_Debug.DebugMessage("COM_CoraConsumesAllTheBooks_Fragments", "Fragment_Stage_0001_Item_00", "FRAGMENT: Stage 1 Item 0 triggered - no setup needed so moving to dialog scene.", 0, Venpi_DebugEnabled.GetValueInt())
  Self.SetObjectiveDisplayed(100, True, False)
EndFunction

Function Fragment_Stage_0210_Item_00()
  VPI_Debug.DebugMessage("COM_CoraConsumesAllTheBooks_Fragments", "Fragment_Stage_0210_Item_00", "Stage 210 Fragment for EAW_Book_HistoryOfPyrates_m triggered.", 0, Venpi_DebugEnabled.GetValueInt())
  ; PlayerRef.RemoveItem(EAW_Book_HistoryOfPyrates_m as Form, 1, False, None)
EndFunction

Function Fragment_Stage_0220_Item_00()
  VPI_Debug.DebugMessage("COM_CoraConsumesAllTheBooks_Fragments", "Fragment_Stage_0220_Item_00", "Stage 220 Fragment for ECS_Book_WhatIfRight triggered.", 0, Venpi_DebugEnabled.GetValueInt())
  ; PlayerRef.RemoveItem(ECS_Book_WhatIfRight as Form, 1, False, None)
EndFunction

Function Fragment_Stage_0230_Item_00()
  VPI_Debug.DebugMessage("COM_CoraConsumesAllTheBooks_Fragments", "Fragment_Stage_0230_Item_00", "Stage 230 Fragment for NH_Book_SimplerTimes_m triggered.", 0, Venpi_DebugEnabled.GetValueInt())
  ; PlayerRef.RemoveItem(NH_Book_SimplerTimes_m as Form, 1, False, None)
EndFunction

Function Fragment_Stage_0260_Item_00()
  VPI_Debug.DebugMessage("COM_CoraConsumesAllTheBooks_Fragments", "Fragment_Stage_0260_Item_00", "Stage 260 Fragment for EAW_Book_OriginofSpecies_m triggered.", 0, Venpi_DebugEnabled.GetValueInt())
  ; PlayerRef.RemoveItem(EAW_Book_OriginofSpecies_m as Form, 1, False, None)
EndFunction

Function Fragment_Stage_0270_Item_00()
  VPI_Debug.DebugMessage("COM_CoraConsumesAllTheBooks_Fragments", "Fragment_Stage_0270_Item_00", "Stage 270 Fragment for EAW_Book_CarrieOfCosmos_m triggered.", 0, Venpi_DebugEnabled.GetValueInt())
  ; PlayerRef.RemoveItem(EAW_Book_CarrieOfCosmos_m as Form, 1, False, None)
EndFunction

Function Fragment_Stage_0280_Item_00()
  VPI_Debug.DebugMessage("COM_CoraConsumesAllTheBooks_Fragments", "Fragment_Stage_0280_Item_00", "Stage 280 Fragment for EAW_Book_WarOfWorlds_m triggered.", 0, Venpi_DebugEnabled.GetValueInt())
  ; PlayerRef.RemoveItem(EAW_Book_WarOfWorlds_m as Form, 1, False, None)
EndFunction

Function Fragment_Stage_0290_Item_00()
  VPI_Debug.DebugMessage("COM_CoraConsumesAllTheBooks_Fragments", "Fragment_Stage_0290_Item_00", "Stage 290 Fragment for EAW_Book_BadJokes1_m triggered.", 0, Venpi_DebugEnabled.GetValueInt())
  ; PlayerRef.RemoveItem(EAW_Book_BadJokes1_m as Form, 1, False, None)
EndFunction

Function Fragment_Stage_0300_Item_00()
  VPI_Debug.DebugMessage("COM_CoraConsumesAllTheBooks_Fragments", "Fragment_Stage_0300_Item_00", "Stage 300 Fragment for EAW_Book_BadJokes2_m triggered.", 0, Venpi_DebugEnabled.GetValueInt())
  ; PlayerRef.RemoveItem(EAW_Book_BadJokes2_m as Form, 1, False, None)
EndFunction

Function Fragment_Stage_0310_Item_00()
  VPI_Debug.DebugMessage("COM_CoraConsumesAllTheBooks_Fragments", "Fragment_Stage_0310_Item_00", "Stage 310 Fragment for EAW_Book_BadJokes3_m triggered.", 0, Venpi_DebugEnabled.GetValueInt())
  ; PlayerRef.RemoveItem(EAW_Book_BadJokes3_m as Form, 1, False, None)
EndFunction

Function Fragment_Stage_0320_Item_00()
  VPI_Debug.DebugMessage("COM_CoraConsumesAllTheBooks_Fragments", "Fragment_Stage_0320_Item_00", "Stage 320 Fragment for EAW_Book_ShipRepair_m triggered.", 0, Venpi_DebugEnabled.GetValueInt())
  ; PlayerRef.RemoveItem(EAW_Book_ShipRepair_m as Form, 1, False, None)
EndFunction

Function Fragment_Stage_0330_Item_00()
  VPI_Debug.DebugMessage("COM_CoraConsumesAllTheBooks_Fragments", "Fragment_Stage_0330_Item_00", "Stage 330 Fragment for EAW_Book_SwordDamocles_m triggered.", 0, Venpi_DebugEnabled.GetValueInt())
  ; PlayerRef.RemoveItem(EAW_Book_SwordDamocles_m as Form, 1, False, None)
EndFunction

Function Fragment_Stage_0340_Item_00()
  VPI_Debug.DebugMessage("COM_CoraConsumesAllTheBooks_Fragments", "Fragment_Stage_0340_Item_00", "Stage 340 Fragment for EAW_Book_Xeno_m triggered.", 0, Venpi_DebugEnabled.GetValueInt())
  ; PlayerRef.RemoveItem(EAW_Book_Xeno_m as Form, 1, False, None)
EndFunction

Function Fragment_Stage_0350_Item_00()
  VPI_Debug.DebugMessage("COM_CoraConsumesAllTheBooks_Fragments", "Fragment_Stage_0350_Item_00", "Stage 350 Fragment for EAW_Book_GravityParadigm_m triggered.", 0, Venpi_DebugEnabled.GetValueInt())
  ; PlayerRef.RemoveItem(EAW_Book_GravityParadigm_m as Form, 1, False, None)
EndFunction

Function Fragment_Stage_0360_Item_00()
  VPI_Debug.DebugMessage("COM_CoraConsumesAllTheBooks_Fragments", "Fragment_Stage_0360_Item_00", "Stage 360 Fragment for Book_StoryOfTheHeavens triggered.", 0, Venpi_DebugEnabled.GetValueInt())
  ; PlayerRef.RemoveItem(Book_StoryOfTheHeavens as Form, 1, False, None)
EndFunction

Function Fragment_Stage_0380_Item_00()
  VPI_Debug.DebugMessage("COM_CoraConsumesAllTheBooks_Fragments", "Fragment_Stage_0380_Item_00", "Stage 380 Fragment for BR_Book_HistoryOfPyrates_2 triggered.", 0, Venpi_DebugEnabled.GetValueInt())
